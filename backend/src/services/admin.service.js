...
export const getRecentOrders = async (days) => {
    ...
    try {
        ...
        logger.error(`getRecentOrders error (days=${parsedDays}): ${error.message}`, error);
        throw new Error(`A apărut o problemă la preluarea evoluției comenzilor: ${error.message}`);
    }
};
...
export const getLowStockProducts = async () => {
    try {
        ...
        logger.error(`getLowStockProducts error: ${error.message}`, error);
...
export const getPendingOrdersFunction = async () => {
    try {
        ...
        logger.error(`getPendingOrdersFunction error: ${error.message}`, error);
